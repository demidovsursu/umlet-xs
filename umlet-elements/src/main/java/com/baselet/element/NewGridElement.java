...
public abstract class NewGridElement implements GridElement {
	...
	protected void resetAndDrawMetaDrawerContent(DrawHandler drawer) {
		...
		drawer.setBackgroundColor(isActive()?ColorOwn.ACTIVE_BG:ColorOwn.SELECTION_BG);
	...
	public String getName() {
		String s=state.getFacetResponse(NameFacet.class, null);
		if(s==null) return "";
		return s;
	}

	public boolean isActive() {
		String s=state.getFacetResponse(ActiveFacet.class, null);
	...
	public List<Stickable> getStartStickables() {
		return handler.getStickableMap().getStartStickables();
	}
	public List<Stickable> getEndStickables() {
		return handler.getStickableMap().getEndStickables();
	}
	public boolean isStickableEnds(Stickable r) {
		return handler.getStickableMap().isStickableEnds(r);
	}
