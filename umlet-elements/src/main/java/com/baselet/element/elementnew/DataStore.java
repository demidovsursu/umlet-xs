...
public class DataStore extends NewGridElement {
	...
	protected Settings createSettings() {
		return new SettingsBase() {
			...
			protected List<Facet> createFacets() {
				return listOf(LayerFacet.INSTANCE, GroupFacet.INSTANCE, NameFacet.INSTANCE, TextPrintFacet.INSTANCE);
			}
		};
	}
