...
public class RelationLineTypeFacet extends FirstRunKeyValueFacet {
	 ...
	 */
	private static final List<ArrowEnd> SHARED_ARROW_STRINGS_BEFORE = Arrays.asList(ArrowEnd.CIRCLE_CROSS, ArrowEnd.CIRCLE, ArrowEnd.DIAGONAL_CROSS,ArrowEnd.CROSSED1,ArrowEnd.DIAMOND,ArrowEnd.FILLED_DIAMOND);
	private static final List<ArrowEnd> SHARED_ARROW_STRINGS_AFTER = Arrays.asList(ArrowEnd.BOX,ArrowEnd.CROSSED);
	private static final List<ArrowEnd> LEFT_ARROW_STRINGS = SharedUtils.mergeLists(SHARED_ARROW_STRINGS_BEFORE, Arrays.asList(ArrowEnd.LEFT_BOX, ArrowEnd.LEFT_FILLED_DIAMOND, ArrowEnd.LEFT_DIAMOND, ArrowEnd.LEFT_FILLED_CLOSED, ArrowEnd.LEFT_CLOSED, ArrowEnd.LEFT_NORMAL, ArrowEnd.LEFT_CROSSED0, ArrowEnd.LEFT_INVERTED1, ArrowEnd.LEFT_INVERTED0, ArrowEnd.LEFT_INVERTED, ArrowEnd.LEFT_INTERFACE_OPEN, ArrowEnd.LEFT_MEASURE_NORMAL), SHARED_ARROW_STRINGS_AFTER);
	private static final List<ArrowEnd> RIGHT_ARROW_STRINGS = SharedUtils.mergeLists(SHARED_ARROW_STRINGS_BEFORE, Arrays.asList(ArrowEnd.RIGHT_BOX, ArrowEnd.RIGHT_FILLED_DIAMOND, ArrowEnd.RIGHT_DIAMOND, ArrowEnd.RIGHT_FILLED_CLOSED, ArrowEnd.RIGHT_CLOSED, ArrowEnd.RIGHT_MEASURE_NORMAL, ArrowEnd.RIGHT_NORMAL,  ArrowEnd.RIGHT_CROSSED0, ArrowEnd.RIGHT_INVERTED1, ArrowEnd.RIGHT_INVERTED0, ArrowEnd.RIGHT_INVERTED, ArrowEnd.RIGHT_INTERFACE_OPEN), SHARED_ARROW_STRINGS_AFTER);
	...
	public void handleValue(String value, PropertiesParserState state) {
		state.setFacetResponse(RelationLineTypeFacet.class, value);
	}
	...
	public KeyValue getKeyValue() {
		return new KeyValue(
				...
				, new ValueInfo("+-", "crossed out arrow")
				, new ValueInfo("++-", "double crossed out arrow")
				, new ValueInfo("+0-", "crossed arrow with circle")
				, new ValueInfo("<>-", "diamond arrow")
				, new ValueInfo("<+>-", "filled diamond arrow")
				, new ValueInfo(">-", "crow's foot arrow")
				, new ValueInfo(">+-", "crossed crow's foot arrow")
				, new ValueInfo(">0-", "crow's foot arrow with circle")
                           );
	}
}
