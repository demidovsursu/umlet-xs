...
abstract class ArrowEnd implements RegexValueHolder {
	...
	static ArrowEnd LEFT_INVERTED1 = new ArrowEnd(">\\+") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.NORMAL, false, true,1);
		}
	};
	static ArrowEnd LEFT_INVERTED0 = new ArrowEnd(">0") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.NORMAL, false, true,0);
		}
	};
	static ArrowEnd CROSSED = new ArrowEnd("\\+") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.CROSSED, false, false);
		}
	};
	static ArrowEnd CROSSED1 = new ArrowEnd("\\+\\+") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.CROSSED, false, false,1);
		}
	};
	static ArrowEnd LEFT_CROSSED0 = new ArrowEnd("\\+0") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.CROSSED, false, false,0);
		}
	};
	static ArrowEnd RIGHT_CROSSED0 = new ArrowEnd("0\\+") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.CROSSED, false, false,0);
		}
	...
	static ArrowEnd RIGHT_INVERTED1 = new ArrowEnd("\\+<") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.NORMAL, false, true,1);
		}
	};
	static ArrowEnd RIGHT_INVERTED0 = new ArrowEnd("0<") {
		@Override
		public void print(DrawHandler drawer, Line lineToDraw, boolean drawOnLineStart, String matchedText, ResizableObject resizableObject) {
			RelationDrawer.drawArrowToLine(drawer, lineToDraw, drawOnLineStart, ArrowEndType.NORMAL, false, true,0);
		}
