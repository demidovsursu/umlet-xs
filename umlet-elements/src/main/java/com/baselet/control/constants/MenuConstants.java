...
public class MenuConstants {
	...
	public static final String SET_ACTIVE = "Start from this";
	public static final String START_EMU = "Start simulation";
	public static final String STOP_EMU = "Stop simulation";
