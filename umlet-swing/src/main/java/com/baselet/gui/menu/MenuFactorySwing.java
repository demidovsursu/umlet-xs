...
public class MenuFactorySwing extends MenuFactory {
	...
	public JMenuItem createSetActive() {
		return createJMenuItem(false, SET_ACTIVE, null);
	}
	...
	public JMenuItem createStartStop() {
		return createJMenuItem(false, START_EMU, null);
	}
